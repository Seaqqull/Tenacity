	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half CAMERA_MODE300 = lerpResult268;
				float temp_output_1215_0 = ( break1245.y * CAMERA_MODE300 );
				half Starts_Bottom_Mask1250 = ceil( temp_output_1215_0 );
...
/*ASEBEGIN
Version=18908
1920;0;1920;1029;-3452.818;1426.234;1;True;False
...
Node;AmplifyShaderEditor.CeilOpNode;1261;-449.3597,-1649.144;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=30DAB37054B7E906F1F95C62D40357E790D903CD